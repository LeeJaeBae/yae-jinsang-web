...
const sections = [
  {
    title: "1. 앱 설치 & 시작",
    desc: "APK를 다운받아 설치하면 온보딩 화면이 나타납니다. 서비스 소개를 확인하고 바로 시작하세요.",
    images: [
  ...
  {
    title: "2. 회원가입 & 로그인",
    desc: "업소명을 입력하고 전화번호 인증으로 가입합니다. 추천코드가 있으면 첫 달 50% 할인!",
    images: [
      { src: "/guide/05_login.png", caption: "로그인 화면" },
    ],
  },
  {
    title: "3. 진상 등록하기",
    desc: "홈 화면에서 전화번호를 입력하고 태그(폭력, 먹튀, 행패, 스토커, 블랙)를 선택한 후 등록하세요. 연락처에서 한번에 가져올 수도 있습니다. 등록된 정보는 다른 업소에서도 조회됩니다.",
    images: [
  ...
  },
  {
    ...
    desc: "전화가 오면 자동으로 진상 여부를 조회합니다. 진상이면 🚨 빨간 경고 카드가, 미등록이면 ✅ 초록 안심 카드가 화면 중앙에 표시됩니다. 업소명 공개에 동의한 업소는 이름도 함께 표시돼요.",
    images: [
